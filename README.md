...
5. `qualcomm_cv_ros` is a ROS package built following these steps [here](https://docs.modalai.com/build-ros-nodes-for-voxl/)
   ...
   2. It is designed to be run on the Qualcomm itself. This involves developing on the host PC and using adb to push updates onto the Qualcomm as [here](https://docs.modalai.com/setup-adb/) or pulling the updates repo directly from GitHub
...
We will likely incorporate this launch file and/or source code into our own to streamline the process.
